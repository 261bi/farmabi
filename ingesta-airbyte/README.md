...
```text
Fuente operativa -> Airbyte -> destino analítico
```
...
```powershell
cd C:\261bi\farmabi\oltp-mysql
docker compose ps

cd C:\261bi\farmabi\dw-pg
docker compose ps
```
...
La configuración detallada del caso `farmabi` está en:

- [SESION_U2_S2_P1_AIRBYTE_REPLICA_MYSQL_POSTGRES.md](../docs/sesiones/SESION_U2_S2_P1_AIRBYTE_REPLICA_MYSQL_POSTGRES.md)
