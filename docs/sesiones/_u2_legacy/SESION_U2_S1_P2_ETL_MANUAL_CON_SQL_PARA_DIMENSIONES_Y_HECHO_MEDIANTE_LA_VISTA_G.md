...
- [2_G_pasos.sql](https://github.com/261bi/farmabi/blob/main/oltp-mysql/2_G_pasos.sql): guion pedagógico para entender la construcción progresiva de la vista `G`.
- [3_poblar.sql](https://github.com/261bi/farmabi/blob/main/oltp-mysql/3_poblar.sql): script operativo final para poblar dimensiones, crear `vw_g_ventas` y cargar `fact_ventas`.

Orden recomendado de ejecución dentro de `oltp-mysql`:

1. [1_dm.sql](https://github.com/261bi/farmabi/blob/main/oltp-mysql/1_dm.sql)
2. [2_G_pasos.sql](https://github.com/261bi/farmabi/blob/main/oltp-mysql/2_G_pasos.sql)
3. [3_poblar.sql](https://github.com/261bi/farmabi/blob/main/oltp-mysql/3_poblar.sql)
