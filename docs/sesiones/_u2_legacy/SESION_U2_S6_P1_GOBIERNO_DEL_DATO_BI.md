...
- exploración OLAP
- storytelling
- comparativos de año previo
- comparativos de mes anterior
- KPI, odómetro y tablas de variación
- interpretación ejecutiva del dashboard
...
| Familia | Agrupación superior de productos |
...
| KPI de variación | Señal visual que indica crecimiento o caída |
...
| `[Ventas Anio Previo Mismo Periodo]` | compara el periodo seleccionado contra el año previo | Moneda | Comercial |
| `[Venta Mes Anterior]` | compara el mes seleccionado contra el mes anterior | Moneda | Comercial |
| `[Variacion Ventas vs Anio Previo]` | `[Ventas Netas] - [Ventas Anio Previo Mismo Periodo]` | Moneda | Comercial |
| `[% Variacion Ventas vs Anio Previo]` | `DIVIDE([Variacion Ventas vs Anio Previo], [Ventas Anio Previo Mismo Periodo])` | Porcentaje | Comercial |
| `[KPI Var Ventas]` | flecha de crecimiento o caída | Texto | Comercial |
